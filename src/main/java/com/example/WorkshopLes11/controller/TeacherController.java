...
import com.example.WorkshopLes11.repository.TeacherRepository;
...
public class TeacherController {
    ...
    public ResponseEntity<String> createTeacher(@RequestBody Teacher teacher) {
        ...
        URI uri = URI.create(
                ServletUriComponentsBuilder.fromCurrentContextPath().path("/teachers/" + savedTeacher.getId()).toUriString());
